# -*- coding: utf-8 -*-
# Generated by Django 1.10.2 on 2016-10-29 01:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='aluno',
            name='forma_ingresso',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Forma_Ingresso'),
        ),
        migrations.AddField(
            model_name='aluno',
            name='matriz_curricular',
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='periodo_conclusao', to='core.Periodo'),
        ),
        migrations.AddField(
            model_name='aluno',
            name='periodo_matricula',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='periodo_matricula', to='core.Periodo'),
        ),
        migrations.AddField(
            model_name='aluno',
            name='situacao',
